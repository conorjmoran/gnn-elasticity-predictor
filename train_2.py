...
try:
    from scripts.train import (
        PtGraphDataset,
        LogTransformer,
        _compute_bin_statistics,
        _gather_bin_values,
        AlignnRegressor,
        compute_error_stats,
    )
except ModuleNotFoundError:
    # Fallback when running as a script without the "scripts" package context
...
def parse_args():
    ...
    p.add_argument("--freq-gamma", type=float, default=1.0)
...
def train_member(
    ...
    *,
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        enable_density = not bool(getattr(args, "disable_density_weighting", False))
        use_weights = (
            enable_density
